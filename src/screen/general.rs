        ...
        opt_helpers::section_view(
            ...
            [
                ...
                opt_helpers::choose(
                    ...
                    Some(config.cross_boundary_behaviour.unwrap_or(CrossBoundaryBehaviour::Monitor)),
                ...
                opt_helpers::choose(
                    ...
                    Some(config.cross_monitor_move_behaviour.unwrap_or(MoveBehaviour::Swap)),
                ...
                opt_helpers::choose(
                    ...
                    Some(config.window_hiding_behaviour.unwrap_or(HidingBehaviour::Cloak)),
